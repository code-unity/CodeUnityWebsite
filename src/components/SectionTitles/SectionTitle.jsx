...
const SectionTitle = ({ title, subTitle1,subTitle2,subTitle3, titleOption, headingOption }) => {
    return (
        <div className={`section-title ${titleOption}`} data-aos="fade-up">
            ...
            <p className="sub-title">{subTitle3}<Link to= "contact" style={{color:"#1292ee"}}>Let us know.</Link></p>
        </div>
    )
}
